...
public interface DocumentStore {
    ...
    List<PercolateQuery> percolateByIds(List<String> ids, String type, int maxMatches);
    ...
    /**
     * Deletes percolator objects matching the given query and type that belong to the user from the index.
     *
     * @param id id of the percolator query to delete
     * @throws org.apache.thrift.TException
     */
    boolean deletePercolator(String id) throws TException;

    /**
     * Get the Visibility of a percolator query
     *
     * @param id ID of the percolator query
     * @return The Visibility of the matching percolator query. null if not found.
     * @throws TException
     */
